...
if __name__ == '__main__':
    codemod.run_interactive(codemod.Query(factories_suggestor, path_filter=is_dart_file))
    codemod.run_interactive(codemod.Query(dollar_props_suggestor, path_filter=is_dart_file))
    ...
    codemod.run_interactive(codemod.Query(generated_parts_suggestor, path_filter=is_dart_file))
