...
class MixinMetadata {
  ...
  factory MixinMetadata.fromJson(Map<String, dynamic> json) =>
      _$MixinMetadataFromJson(json);
...
class MixinResult {
  ...
  factory MixinResult.fromJson(Map<String, dynamic> json) =>
      _$MixinResultFromJson(json);
...
class PropResult {
  ...
  factory PropResult.fromJson(Map<String, dynamic> json) =>
      _$PropResultFromJson(json);
