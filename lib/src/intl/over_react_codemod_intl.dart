...
class OverReactCodemodIntl {
  static String get commonMessage => Intl.message(
      'Check that `pub get` has been run and that this is a valid over_react component usage.',
      name: 'OverReactCodemodIntl_commonMessage');

  static String get fixmePrefix => Intl.message('FIXME:over_react_codemod',
      name: 'OverReactCodemodIntl_fixmePrefix');

  static String get manualValidationCommentSubstring =>
      Intl.message('Check this box upon manual',
          name: 'OverReactCodemodIntl_manualValidationCommentSubstring');

  static String get outlineLinkButtonSkin =>
      Intl.message('ButtonSkin.OUTLINE_LINK',
          name: 'OverReactCodemodIntl_outlineLinkButtonSkin');

  static String get semverReportNotAvailable => Intl.message(
      'Semver report not available; this class is assumed to be public and thus will not be updated.',
      name: 'OverReactCodemodIntl_semverReportNotAvailable');

  static String get temporaryCompanionClassComment => Intl.message(
      'This will be removed once the transition to Dart 2 is complete.',
      name: 'OverReactCodemodIntl_temporaryCompanionClassComment');

  static String get warning =>
      Intl.message('Could not find semver_report.json.',
          name: 'OverReactCodemodIntl_warning');
}
